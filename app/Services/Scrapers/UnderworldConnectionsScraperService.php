 ...
 */
class UnderworldConnectionsScraperService implements ScraperContract
{
	 ...
	 * @var string
	 */
	protected $url = "https://underworldconnections.com/product/";

	protected $vendor = "UnderworldConnections";
	/**
	 * @var Client
	 */
	protected $client;
	...
	/**
	 * UnderworldConnectionsScraperService constructor.
	 */
